...
<html lang="ko-KR">
    <head>
        ...
        <title>비밀번호 변경 - 가즈-아(GAZ-AAA) 연습용 가상화폐 거래소</title>
        <?php session_start(); ?>
    </head>
    <body>
        <div class="Header">
            ...
            <div class="InputForm">
                ...
                <form action="ChangePW.php" method="POST">
                    <div class="FindID">
                        ...
                        <input type="password" name="UserLegacyPW" placeholder="기존 비밀번호 입력" minlength="8" maxlength="20" required>
                        <br>
                        <label for="UserPW">새 비밀번호*</label>
                        <input type="password" name="UserPW" placeholder="새 비밀번호 입력" minlength="8" maxlength="20" required>
                        <br>
                        <label for="UserPWChk">새 비밀번호 확인*</label>
                        <input type="password" name="UserPWChk" placeholder="새 비밀번호 재입력" minlength="8" maxlength="20" required>
                    </div>
